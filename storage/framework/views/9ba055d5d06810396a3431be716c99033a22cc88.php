...
<div class="container mt-4">
    <form id="uploadForm" enctype="multipart/form-data" method="post" action="<?php echo e(route('upload')); ?>">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\ocrBooks\resources\views/books/scan.blade.php ENDPATH**/ ?>