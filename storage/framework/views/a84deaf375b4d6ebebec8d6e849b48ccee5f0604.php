...
<body>
    <div class="mt-4">
        <div class="container">           
            ...
            <?php if(\Session::has('IDerror')): ?>
                <div class="alert alert-danger alert-dismissible" role="alert">
                    아이디를 찾을 수 없습니다.
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
                <?php elseif(\Session::has('PWDerror')): ?>
                <div class="alert alert-danger alert-dismissible" role="alert">
                    비밀번호가 잘못되었습니다.
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
            ...
            <?php endif; ?>            
            <form method="POST" action="<?php echo e(url('/login/check')); ?>" class="mb-4">
                <?php echo csrf_field(); ?>
            ...
            <p class="forgot-password">아직 회원이 아니신가요? <a href="<?php echo e(url('signup')); ?>" style="color: #007bff;">회원가입</a></p>
        </div>
    </div>
...
<?php /**PATH C:\xampp\ocrBooks\resources\views/account/login.blade.php ENDPATH**/ ?>