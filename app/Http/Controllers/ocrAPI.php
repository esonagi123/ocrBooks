      ...
      if ($request->hasFile('image')) {
        ...
        foreach ($images as $image) {
            ...
            if($status_code == 200) {
              ...
              $data['shop'] = $data['images'][0]['fields'][0]['inferText']; // 상호명
              $data['date'] = $data['images'][0]['fields'][1]['inferText']; // 날짜
              $data['amount'] = $data['images'][0]['fields'][2]['inferText']; // 총액


              return view('m_books.scanResult', $data);
